...
interface StudentTableProps {
  ...
  onStudentAction?: (actionType: string, student: Student) => void;
}

export function StudentTable({ students, onStudentClick, onStudentAction }: StudentTableProps) {
    ...
    <>
      ...
      <StudentProfileModal
        ...
        onAction={(actionType, student) => {
          onStudentAction?.(actionType, student);
        }}
      />
    </>
  );
